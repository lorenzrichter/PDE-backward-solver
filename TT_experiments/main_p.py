...
def main_p(nos = 2000, method='impl', problem='HJB', seed=42):    
    ...
    # testOde.test()
    testpolit = pol_it.Pol_it(vfun, testOde, polit_params, seed)
    ...
    # solve HJB
    testpolit.solve_HJB()
    print('result, rel_error', testpolit.avg, testpolit.rel_error)
    t10 = time.time()
    ...
    return testpolit.avg, testpolit.rel_error, t11 - t01
